...
> 🚀 **Теперь доступны две версии интерфейса:** Streamlit (веб) и PyQt5 (desktop)!
...
Проект предоставляет **два варианта интерфейса**:
- 🌐 **Streamlit** - веб-интерфейс для работы через браузер
- 💻 **PyQt5** - нативное desktop приложение

Оба варианта позволяют загружать документы (изображения, PDF, Excel, DOCX, TXT) и автоматически извлекать из них структурированные табличные данные в формате Excel или JSON.


## Ключевые возможности

- ✅ **Поддержка множества форматов**: изображения (JPG, PNG), PDF, Excel (XLSX, XLS), DOCX, TXT
- 🤖 **Выбор AI-моделей**: локальные модели (Qwen 3) или облачные (OpenAI ChatGPT)
...
- Единый интерфейс для различных моделей (Qwen, OpenAI)
...
### Вариант 1: PyQt5 Desktop приложение (рекомендуется) 💻
...
📖 **Подробная документация:** [QUICKSTART_QT5.md](QUICKSTART_QT5.md)
...
| Характеристика | Streamlit | PyQt5 |
|----------------|-----------|-------|
| Тип | Веб-приложение | Desktop |
| Запуск | Через браузер | Нативное окно |
| Скорость | Средняя | Высокая |
| Установка | Уже включен | `pip install PyQt5` |

📊 **Детальное сравнение:** [COMPARISON_STREAMLIT_VS_QT5.md](COMPARISON_STREAMLIT_VS_QT5.md)
